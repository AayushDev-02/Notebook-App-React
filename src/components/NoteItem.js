...
const NoteItem = (props) => {
    ...
    return (
        <div className='text-primary_text flex'>
            ...
            <div  className="block max-w-sm p-6 space-y-5 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <div className='flex space-x-5'>
                    ...
                    <div ><MdModeEdit onClick={updateNote}/></div>
                </div>
            </div>
        </div>
    )
